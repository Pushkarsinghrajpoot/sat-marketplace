...
export function mapDeal(dbDeal: any): any {
  ...
  return {
    ...
    opportunityName: dbDeal.opportunity_name,
    estimatedValue: dbDeal.estimated_value,
...
export function mapDirectQuery(dbQuery: any): any {
  ...
  return {
    ...
    estimatedBudget: dbQuery.estimated_budget,
    urgency: dbQuery.urgency,
