...
export default function ResellerConversationPage() {
  ...
  useEffect(() => {
    ...
    const subscription = supabase
      .channel(`reseller-conversation-${params.id}`)
      .on('postgres_changes', {
        event: 'INSERT',
        schema: 'public',
        table: 'chat_messages',
              ...
              <CardContent>
                <div className="space-y-2">
                  <div>
                    ...
                    <p className="font-medium">{conversation.organizations.name}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
