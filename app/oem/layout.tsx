...
import { LayoutDashboard, Users, Settings, LogOut, Bell, Menu, X } from 'lucide-react';
...
const navigation = [
  ...
  { name: 'Partner Directory', href: '/oem/partners', icon: Users },
        ...
        <aside className={`${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-gray-200 transition-transform lg:translate-x-0 lg:static lg:inset-0`}>
          <div className="flex h-full flex-col">
            <div className="flex h-16 items-center justify-between px-6 border-b border-gray-200">
              <Link href="/oem/dashboard" className="flex items-center gap-2">
              ...
              <div className="mb-6 px-3">
                ...
                <div className="mt-2 flex items-center gap-3">
                  <div className="w-10 h-10 bg-purple-100 rounded-lg flex items-center justify-center">
                    <span className="text-sm font-bold text-purple-600">{organization?.name.charAt(0)}</span>
                  </div>
