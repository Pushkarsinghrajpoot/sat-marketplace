...
import { getRatingStats } from '@/lib/rating-helpers';
import { RatingDisplay } from '@/components/ratings/RatingDisplay';

export default function DistributorRatingsPage() {
    ...
    <div className="p-6 lg:p-8">
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Track your performance ratings from resellers</p>
        </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-semibold">
                        {stats.average_rating >= 4.5 ? 'Excellent Service' :
                         stats.average_rating >= 4.0 ? 'Good Service' :
                         stats.average_rating >= 3.5 ? 'Average Service' :
                         'Needs Improvement'}
                      </p>
                      <p className="text-sm text-gray-600">
                        {stats.average_rating >= 4.5 ? 'Outstanding performance! Keep it up.' :
                         stats.average_rating >= 4.0 ? 'Strong performance. Aim for 4.5+ for excellence.' :
                         stats.average_rating >= 3.5 ? 'Focus on improving response time and pricing.' :
                         'Review feedback and improve service quality.'}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    ...
                    <ul className="text-sm text-blue-800 space-y-1 ml-4">
                      ...
                      <li>• Respond to quotes quickly</li>
                      <li>• Maintain stock availability</li>
                      <li>• Offer excellent after-sales support</li>
                    </ul>
                  </div>
                </div>
              </div>
