  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Chat conversations with customers and resellers</p>
      </div>
              ...
              <Card key={conv.id} className="hover:shadow-md transition-shadow">
                <CardContent className="p-6">
                  <div className="flex items-start justify-between">
                      ...
                      <div className="grid md:grid-cols-2 gap-4 mb-3">
                        ...
                        {conv.users && (
                          <div>
                            ...
                            <p className="font-medium">{conv.users.name}</p>
                            <p className="text-sm text-gray-500">{conv.users.email}</p>
                          </div>
                        )}
                      </div>
                    ...
                    <Link href={`/distributor/messages/${conv.id}`}>
                      <Button>
                        <Eye className="h-4 w-4 mr-2" />
                        {unreadCount > 0 ? 'Respond' : 'View'}
                      </Button>
                    </Link>
                  </div>
                </CardContent>
